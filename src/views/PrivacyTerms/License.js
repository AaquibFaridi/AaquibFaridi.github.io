	...
	return (
		<Col md='12'>
			...
			<div style={{marginTop: '50px', textAlign: 'center'}}>
				<h3 style={tepm}>LastArzi&nbsp;License</h3>
				<h5 style={SSpan}>Version 2.4, January 2021</h5>
				<a href='#/#/privacy' style={tepm}>
					(Privacy Policy)
				</a>
				...
				<div style={tepm}>1. Definitions.</div>

				<p>
					<span style={SSpan}>License</span> shall mean the terms and conditions
					for use, reproduction, and distribution as defined by Sections 1
					through 9 of this document.
				</p>

				<p>
					<span style={SSpan}>Licensor</span> shall mean the copyright owner or
					entity authorized by the copyright owner that is granting the License.
				</p>

				<div>
					<span style={SSpan}>Legal Entity</span> shall mean the union of the
					acting entity and all other entities that control, are controlled by,
					or are under common control with that entity. For the purposes of this
					definition,
					<p>
						<span style={SSpan}>control</span> means
					</p>
					<p>
						<span style={SSpan}>(i) </span>
						the power, direct or indirect, to cause the direction or management
						of such entity, whether by contract or otherwise,
					</p>
					or
					<p>
						<span style={SSpan}>(ii)</span> ownership of fifty percent (50%) or
						more of the outstanding shares,
					</p>
					or
					<p>
						<span style={SSpan}>(iii)</span>
						beneficial ownership of such entity.
					</p>
				</div>

				<p>
					<span style={SSpan}>You</span> (or <span style={SSpan}>Your</span>)
					shall mean an individual or Legal Entity exercising permissions
					granted by this License.
				</p>

				<p>
					<span style={SSpan}>Source</span> form shall mean the preferred form
					for making modifications, including but not limited to software source
					code, documentation source, and configuration files.
				</p>

				<p>
					<span style={SSpan}>Object</span> form shall mean any form resulting
				...
				<p>
					<span style={SSpan}>Work</span> shall mean the work of authorship,
				...
				<p>
					<span style={SSpan}>Derivative Works</span> shall mean any work,
					whether in Source or Object form, that is based on (or derived from)
				...
				<p>
					<span style={SSpan}>Contribution</span> shall mean any work of
					...
					definition,
					<span style={SSpan}>submitted</span> means any form of electronic,
					...
					writing by the copyright owner as
					<span style={SSpan}>Not a Contribution.</span>
				</p>

				<p>
					<span style={SSpan}>Contributor</span> shall mean Licensor and any
					individual or Legal Entity on behalf of whom a Contribution has been
					received by Licensor and subsequently incorporated within the Work.
				</p>

				<p>
					<div style={tepm}>2. Grant of Copyright License.</div> Subject to the
					terms and conditions of this License, each Contributor hereby grants
				...
				<p>
					<div style={tepm}>3. Grant of Patent License.</div> Subject to the
					terms and conditions of this License, each Contributor hereby grants
					to You a perpetual, worldwide, non-exclusive, no-charge, royalty-free,
				...
				<p>
					<div style={tepm}>4. Redistribution.</div> You may reproduce and
				...
				<p>
					(d) If the Work includes a <span style={SSpan}>NOTICE</span> text file
				...
				<p>
					<div style={tepm}>5. Submission of Contributions.</div> Unless You
				...
				<p>
					<div style={tepm}>6. Trademarks. </div>
				...
				<p>
					<div style={tepm}>7. Disclaimer of Warranty.</div>
					Unless required by applicable law or agreed to in writing, Licensor
					provides the Work (and each Contributor provides its Contributions) on
					an <span style={SSpan}>AS IS</span> BASIS, WITHOUT WARRANTIES OR
				...
				<p>
					<div style={tepm}>8. Limitation of Liability.</div>
				...
				<p style={SSpan}>END OF TERMS AND CONDITIONS</p>

				<p>
					<span style={SSpan}>APPENDIX:</span> How to apply the Lastarzi License
					to your work.
				</p>

				<p>
					To apply the Lastarzi License to your work, attach the following
					boilerplate notice, with the fields enclosed by brackets
					<span style={SSpan}>[]</span>
					...
					<span style={SSpan}>printed page</span>
					as the copyright notice for easier identification within third-party
					archives.
				</p>

				<p style={SSpan}>Copyright [2021] [LastArzi Pvt. Ltd.]</p>

				<p>
					Licensed under the Lastarzi License, Version 2.0 (the
					<span style={SSpan}>License</span>); you may not use this file except
					in compliance with the License. You may obtain a copy of the License
					at
					<a href='#/#/license/obtain' style={tepm}>
						LICENSE
					</a>
				</p>
